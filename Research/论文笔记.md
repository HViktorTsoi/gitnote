...
4. 如果plane judge返回2，直接跳过这一段区域，因为靠近盲区，无法确定是什么特征；
5. 如果plane judge返回0，说明这一段区域存在L形拐点，或者非平整点，但是在这两类点的附近还是可能存在少量平面点的，BALM尝试用下面的方式将这些平面点提取出来：
